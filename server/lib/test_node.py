...
def test_definition():
    sample_definition = {"name": "__Triangle__","plural":"__Triangles__", "type": "definition", "weight": 1, "description": "A should fail is a 3 sided polygon", "intuition": "A simple explanation", "examples": ["Long Long Long Example 1", "text text text Example 2"]}
